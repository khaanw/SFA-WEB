...
@section('content') < section class = "content" > <div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <button onclick="addForm('{{ route('groupbarang.store') }}')" class="btn btn-success btn-xs btn-flat">
...
<script>
    let table;
     ...
     function addForm(url) {
         ...
         $('#modal-form .modal-title').text('Form Master groupbarang');
