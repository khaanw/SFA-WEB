<!-- Modal -->
<div class="modal fade" id="modal-cust" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" width="80px">
            ...
            <table class="table table-stripped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$item->alamat}}</td>
                        <td>
                            <a href="{{route('pembelian.create',$item->idSupplier)}}" class="btn btn-primary btn-xs btn-flat"> --}}
                                {{-- <i class="fa fa-check-circle">Pilih</i></button>
                        </td>
                    </tr>
                    @endforeach --}}
