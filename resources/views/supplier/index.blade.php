...
<script>
    let table;
     ...
     function editForm(url) {
         ...
         $.get(url)
             .done((response) => {
                $('#modal-form [name=nama]').val(response.vendorName);
                $('#modal-form [name=alamat]').val(response.vendorAddress1);
                $('#modal-form [name=telepon]').val(response.vendorPhone);
                $('#modal-form [name=top]').val(response.vendorTermOfPayment);
